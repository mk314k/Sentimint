...
import ChatBubbleIcon from './icons/chat-bubble-left-right.svg';
...
function Menu(props) {
    return (
        <div className='menu'>
            <h1 className='menu__header'>Sentimint</h1>
            <div className='menu__section'>
                <div className='menu__section__header'>MAIN</div>
                <div className='menu__item'>
                    <img src={HomeIcon} className='menu__item__icon' />
                    <div className='menu__item__label'>Overview</div>
                </div>
                <div className='menu__item'>
                    <img src={StarIcon} className='menu__item__icon' />
                    <div className='menu__item__label'>Reviews</div>
                </div>
                <div className='menu__item'>
                    <img src={ChatBubbleIcon} className='menu__item__icon' />
                    <div className='menu__item__label'>Social</div>
                </div>
                <div className='menu__item'>
                    <img src={ChartBarIcon} className='menu__item__icon' />
            ...
            <div className='menu__section'>
                ...
                <div className='menu__item'>
                    <img src={HeartIcon} className='menu__item__icon' />
                    <div className='menu__item__label'>Sentiment</div>
                </div>
                <div className='menu__item'>
                    <img src={MapPinIcon} className='menu__item__icon' />
